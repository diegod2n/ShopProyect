package com.barber.shop.service.CartService;
...
import com.barber.shop.Repository.AddToCartRepo;
import com.barber.shop.Repository.CheckoutRepo;
import com.barber.shop.model.AddtoCart;
import com.barber.shop.model.CheckoutCart;
...
public class CartSerivceImpl implements CartService {
	...
	public List<AddtoCart> addCartbyUserIdAndProductId(long productId, long userId,int qty,double price) throws Exception {
		try {
			...
			obj.setPrice(price);
			Date date = new Date();
			obj.setAdded_date(date.toString());
